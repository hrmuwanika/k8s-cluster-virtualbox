...
│                        └──────────────┘         │
│                                                 │
│  Kubernetes Cluster (kubeadm + Flannel)         │
│  Node.js REST API (3 replicas)                  │
└─────────────────────────────────────────────┘
```
...
│   ├── ansible.cfg
│   ├── playbooks/
│   │   ├── prepare-nodes.yml    # Install K8s dependencies
│   │   ├── master-init.yml      # Initialize master node
│   │   ├── workers-join.yml     # Join workers to cluster
│   │   ├── deploy-app.yml       # Deploy Node.js API
...
2. ✓ Provision VMs with Terraform (1 master + 2 workers)
3. ✓ Install Kubernetes with Ansible
4. ✓ Deploy Node.js REST API
